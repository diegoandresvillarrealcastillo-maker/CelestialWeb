...
export default async function CatalogPage({ searchParams }: { searchParams: Promise<{ category?: string }> }) {
  ...
  return <main className="catalog-page"><section className="page-hero compact"><p className="eyebrow"><span /> Catálogo Celestial</p><h1>Elige la luz de<br /><em>tu próximo momento.</em></h1><p>Todos nuestros diseños, aromas y detalles reunidos en un solo lugar.</p></section><CatalogExplorer initialProducts={products} initialCategory={query.category} /></main>;
}
